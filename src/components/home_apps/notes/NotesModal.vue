...
<template>
  ...
  >
    <div class="bg-violet-300 rounded-lg p-4">
      ...
      <select class = "rounded" v-model ="note.color" id="color">
        <option class = "text-gray-800 " value="pink">Pink</option>
        <option class = "text-gray-800" value="violet">Violet</option>
      </select>
